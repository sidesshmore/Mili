...
import 'package:mindmate/features/Onboarding/ui/onboarding-8.dart';
import 'package:mindmate/features/Onboarding/ui/onboarding-6.dart';
...
class _OnboardingSevenState extends State<OnboardingSeven> {
  ...
  Widget _buildStatusButton(String text) {
    bool isSelected = selectedRelationshipStatus == text;
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            selectedRelationshipStatus = text;
          });
        },
        child: Container(
            ...
            children: [
              Column(
                children: [
                  ...
                  _buildStatusButton("Single"),
                  SizedBox(height: screenHeight * 0.01),
                  _buildStatusButton("In a relationship"),
                  SizedBox(height: screenHeight * 0.01),
                  _buildStatusButton("Married"),
                  SizedBox(height: screenHeight * 0.01),
                  _buildStatusButton("Divorced"),
                  SizedBox(height: screenHeight * 0.01),
                  _buildStatusButton("Widowed"),
                  SizedBox(height: screenHeight * 0.01),
                  _buildStatusButton("Other"),
                ],
              ),
              Column(
                children: [
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          OnboardingService.setRelationshipStatus(
